...
TEST(varray_view, constructor)
{
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v2.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v3.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v51.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v6.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v7.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v8.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v10.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v11.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v12.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v13.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v131.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v14.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v15.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v16.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v17.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v18.lengths());
...
TEST(varray_view, reset)
{
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v1.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 2, 5}), v9.lengths());
...
TEST(varray_view, assign)
{
    ...
    EXPECT_EQ((vector<len_type>{2, 3}), v1.lengths());
...
TEST(varray_view, lower)
{
    ...
    EXPECT_EQ((vector<len_type>{4, 10}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v3.strides());
    EXPECT_EQ(v1.data(), v3.data());

    auto v4 = v1.lowered({});
    EXPECT_EQ((vector<len_type>{40}), v4.lengths());
    ...
    EXPECT_EQ((vector<len_type>{4, 10}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v1.strides());
    EXPECT_EQ(data, v1.data());

    v1.lower({});
    EXPECT_EQ((vector<len_type>{40}), v1.lengths());
...
TEST(varray_view, vary)
{
    ...
    auto v3 = vary(m2[0]);
    EXPECT_EQ((vector<len_type>{2, 5}), v3.lengths());
...
TEST(varray_view, front_back)
{
    ...
    auto v4 = v2.front(1);
    EXPECT_EQ((vector<len_type>{4, 5}), v4.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v4.strides());
    EXPECT_EQ(data, v4.data());

    auto v5 = v2.cback(0);
    EXPECT_EQ((vector<len_type>{2, 5}), v5.lengths());
    EXPECT_EQ((vector<stride_type>{5, 1}), v5.strides());
    EXPECT_EQ(data + 30, v5.data());

    auto v6 = v2.back(1);
    EXPECT_EQ((vector<len_type>{4, 5}), v6.lengths());
...
TEST(varray_view, access)
{
    ...
    EXPECT_EQ((vector<len_type>{4, 2}), v2.lengths());
    EXPECT_EQ((vector<stride_type>{3, 1}), v2.strides());
    EXPECT_EQ(v1.data(), v2.data());

    auto v3 = v1(range(0, 4, 2), 1);
    EXPECT_EQ((vector<len_type>{2}), v3.lengths());
...
TEST(varray_view, length_stride)
{
    ...
    EXPECT_EQ((vector<len_type>{2, 2, 7}), v1.lengths());
...
TEST(varray_view, swap)
{
    ...
    EXPECT_EQ((vector<len_type>{3, 8}), v1.lengths());
    ...
    EXPECT_EQ((vector<len_type>{3, 8}), v2.lengths());
