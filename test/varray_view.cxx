...
TEST(varray_view, constructor)
{
    ...
    EXPECT_EQ(0, v1.dimension());
    EXPECT_EQ(nullptr, v1.data());

    varray_view<double> v2({4, 2, 5}, data);
    EXPECT_EQ(3, v2.dimension());
    EXPECT_EQ(data, v2.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v2.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v2.strides());

    varray_view<double> v3(vector<char>{4, 2, 5}, data);
    EXPECT_EQ(3, v3.dimension());
    EXPECT_EQ(data, v3.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v3.strides());

    varray_view<double> v4({4, 2, 5}, data, layout::COLUMN_MAJOR);
    EXPECT_EQ(3, v4.dimension());
    EXPECT_EQ(data, v4.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v4.lengths());
    EXPECT_EQ((vector<stride_type>{1, 4, 8}), v4.strides());

    varray_view<double> v5(v2);
    EXPECT_EQ(3, v5.dimension());
    EXPECT_EQ(data, v5.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v5.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v5.strides());

    varray_view<double> v51(v0);
    EXPECT_EQ(3, v51.dimension());
    EXPECT_EQ(v0.data(), v51.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v51.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v51.strides());

    varray_view<double> v6(varray_view<double>({4, 2, 5}, data));
    EXPECT_EQ(3, v6.dimension());
    EXPECT_EQ(data, v6.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v6.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v6.strides());

    varray_view<double> v7({4, 2, 5}, data, {3, 8, 24});
    EXPECT_EQ(3, v7.dimension());
    EXPECT_EQ(data, v7.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v7.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v7.strides());

    varray_view<double> v8(vector<char>{4, 2, 5}, data, vector<char>{3, 8, 24});
    EXPECT_EQ(3, v8.dimension());
    EXPECT_EQ(data, v8.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v8.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v8.strides());

    varray_view<const double> v9;
    EXPECT_EQ(0, v9.dimension());
    EXPECT_EQ(nullptr, v9.data());

    varray_view<const double> v10({4, 2, 5}, data);
    EXPECT_EQ(3, v10.dimension());
    EXPECT_EQ(data, v10.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v10.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v10.strides());

    varray_view<const double> v11(vector<char>{4, 2, 5}, data);
    EXPECT_EQ(3, v11.dimension());
    EXPECT_EQ(data, v11.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v11.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v11.strides());

    varray_view<const double> v12({4, 2, 5}, data, layout::COLUMN_MAJOR);
    EXPECT_EQ(3, v12.dimension());
    EXPECT_EQ(data, v12.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v12.lengths());
    EXPECT_EQ((vector<stride_type>{1, 4, 8}), v12.strides());

    varray_view<const double> v13(v2);
    EXPECT_EQ(3, v13.dimension());
    EXPECT_EQ(data, v13.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v13.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v13.strides());

    varray_view<const double> v131(v0);
    EXPECT_EQ(3, v131.dimension());
    EXPECT_EQ(v0.data(), v131.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v131.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v131.strides());

    varray_view<const double> v14(v10);
    EXPECT_EQ(3, v14.dimension());
    EXPECT_EQ(data, v14.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v14.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v14.strides());

    varray_view<const double> v15(varray_view<double>({4, 2, 5}, data));
    EXPECT_EQ(3, v15.dimension());
    EXPECT_EQ(data, v15.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v15.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v15.strides());

    varray_view<const double> v16(varray_view<const double>({4, 2, 5}, data));
    EXPECT_EQ(3, v16.dimension());
    EXPECT_EQ(data, v16.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v16.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v16.strides());

    varray_view<const double> v17({4, 2, 5}, data, {3, 8, 24});
    EXPECT_EQ(3, v17.dimension());
    EXPECT_EQ(data, v17.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v17.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v17.strides());

    varray_view<const double> v18(vector<char>{4, 2, 5}, data, vector<char>{3, 8, 24});
    EXPECT_EQ(3, v18.dimension());
    EXPECT_EQ(data, v18.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v18.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v18.strides());
}
...
TEST(varray_view, reset)
{
    ...
    v1.reset({4, 2, 5}, data);
    EXPECT_EQ(3, v1.dimension());
    EXPECT_EQ(data, v1.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v1.strides());
    ...
    v1.reset({4, 2, 5}, data, layout::COLUMN_MAJOR);
    EXPECT_EQ(3, v1.dimension());
    EXPECT_EQ(data, v1.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{1, 4, 8}), v1.strides());
    ...
    EXPECT_EQ(data, v1.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v1.strides());
    ...
    v9.reset({4, 2, 5}, data);
    EXPECT_EQ(3, v9.dimension());
    EXPECT_EQ(data, v9.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v9.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v9.strides());
    ...
    v9.reset({4, 2, 5}, data, layout::COLUMN_MAJOR);
    EXPECT_EQ(3, v9.dimension());
    EXPECT_EQ(data, v9.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v9.lengths());
    EXPECT_EQ((vector<stride_type>{1, 4, 8}), v9.strides());
    ...
    EXPECT_EQ(data, v9.data());
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v9.lengths());
    EXPECT_EQ((vector<stride_type>{3, 8, 24}), v9.strides());
...
TEST(varray_view, assign)
{
    ...
    EXPECT_EQ((vector<idx_type>{2, 3}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{3, 1}), v1.strides());
...
TEST(varray_view, permute)
{
    ...
    EXPECT_EQ((vector<idx_type>{2, 4, 5}), v2.lengths());
    EXPECT_EQ((vector<stride_type>{5, 10, 1}), v2.strides());
    EXPECT_EQ(v1.data(), v2.data());

    auto v3 = v1.permuted(vector<char>{2, 0, 1});
    EXPECT_EQ((vector<idx_type>{5, 4, 2}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{1, 10, 5}), v3.strides());
    EXPECT_EQ(v1.data(), v3.data());

    v1.permute({1, 0, 2});
    EXPECT_EQ((vector<idx_type>{2, 4, 5}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{5, 10, 1}), v1.strides());
    EXPECT_EQ(data, v1.data());

    v1.permute(vector<char>{2, 0, 1});
    EXPECT_EQ((vector<idx_type>{5, 2, 4}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{1, 5, 10}), v1.strides());
    EXPECT_EQ(data, v1.data());
}
...
TEST(varray_view, lower)
{
    ...
    EXPECT_EQ((vector<idx_type>{4, 10}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v3.strides());
    EXPECT_EQ(v1.data(), v3.data());

    auto v4 = v1.lowered({});
    EXPECT_EQ((vector<idx_type>{40}), v4.lengths());
    EXPECT_EQ((vector<stride_type>{1}), v4.strides());
    ...
    EXPECT_EQ((vector<idx_type>{4, 10}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v1.strides());
    EXPECT_EQ(data, v1.data());

    v1.lower({});
    EXPECT_EQ((vector<idx_type>{40}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{1}), v1.strides());
    EXPECT_EQ(data, v1.data());
}
...
TEST(varray_view, fix)
{
    ...
    auto m1 = fix<3>(v1);
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), m1.lengths());
...
TEST(varray_view, vary)
{
    ...
    auto v3 = vary(m2[0]);
    EXPECT_EQ((vector<idx_type>{2, 5}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{5, 1}), v3.strides());
    EXPECT_EQ(m1.data(), v3.data());

    auto v4 = vary(m2[slice::all]);
    EXPECT_EQ((vector<idx_type>{4, 2, 5}), v4.lengths());
    EXPECT_EQ((vector<stride_type>{10, 5, 1}), v4.strides());
...
TEST(varray_view, front_back)
{
    ...
    auto v4 = v2.front(1);
    EXPECT_EQ((vector<idx_type>{4, 5}), v4.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v4.strides());
    EXPECT_EQ(data, v4.data());

    auto v5 = v2.cback(0);
    EXPECT_EQ((vector<idx_type>{2, 5}), v5.lengths());
    EXPECT_EQ((vector<stride_type>{5, 1}), v5.strides());
    EXPECT_EQ(data + 30, v5.data());

    auto v6 = v2.back(1);
    EXPECT_EQ((vector<idx_type>{4, 5}), v6.lengths());
    EXPECT_EQ((vector<stride_type>{10, 1}), v6.strides());
...
TEST(varray_view, access)
{
    ...
    EXPECT_EQ((vector<idx_type>{4, 2}), v2.lengths());
    EXPECT_EQ((vector<stride_type>{3, 1}), v2.strides());
    EXPECT_EQ(v1.data(), v2.data());

    auto v3 = v1(range(0, 4, 2), 1);
    EXPECT_EQ((vector<idx_type>{2}), v3.lengths());
    EXPECT_EQ((vector<stride_type>{6}), v3.strides());
...
TEST(varray_view, length_stride)
{
    ...
    EXPECT_EQ((vector<idx_type>{2, 2, 7}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{12, 5, 2}), v1.strides());
}
...
TEST(varray_view, swap)
{
    ...
    EXPECT_EQ((vector<idx_type>{3, 8}), v1.lengths());
    EXPECT_EQ((vector<stride_type>{8, 1}), v1.strides());
    ...
    EXPECT_EQ((vector<idx_type>{3, 8}), v2.lengths());
