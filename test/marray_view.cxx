...
TEST(marray_view, constructor)
{
    ...
    marray_view<double,3> v4({4, 2, 5}, data, layout::COLUMN_MAJOR);
    ...
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), v7.lengths());
    ...
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), v15.lengths());
    ...
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), v18.lengths());
...
TEST(marray_view, reset)
{
    ...
    v2.reset({4, 2, 5}, data, layout::COLUMN_MAJOR);
    EXPECT_EQ(data, v2.data());
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), v2.lengths());
    ...
    v2.reset();
    EXPECT_EQ(nullptr, v1.data());
    EXPECT_EQ((array<idx_type,3>{0, 0, 0}), v2.lengths());
...
TEST(marray_view, permute)
{
    ...
    v1.permute({1, 0, 2});
    EXPECT_EQ((array<idx_type,3>{2, 4, 5}), v1.lengths());
    EXPECT_EQ((array<stride_type,3>{5, 10, 1}), v1.strides());
    EXPECT_EQ(data, v1.data());

    v1.permute(array<char,3>{2, 0, 1});
    EXPECT_EQ((array<idx_type,3>{5, 2, 4}), v1.lengths());
...
TEST(marray_view, transpose)
{
    ...
    v1.transpose();
    EXPECT_EQ((array<idx_type,2>{8, 4}), v1.lengths());
...
TEST(marray_view, front_back)
{
    ...
    auto v5 = v2.cback(0);
    EXPECT_EQ((array<idx_type,2>{2, 5}), v5.lengths());
    EXPECT_EQ((array<stride_type,2>{5, 1}), v5.strides());
    EXPECT_EQ(data + 30, v5.data());

    auto v6 = v2.back(1);
    EXPECT_EQ((array<idx_type,2>{4, 5}), v6.lengths());
...
TEST(marray_view, length_stride)
{
    ...
    EXPECT_EQ((array<idx_type,3>{2, 2, 7}), v1.lengths());
