...
TEST(indexed_dpd_varray, constructor)
{
    ...
    for (int j = 0;j < 6;j++)
    {
        ...
        indexed_dpd_varray<double> v3(1, 2, array<array<char,2>,6>{{{3, 1}, {2, 2}, {1, 2}, {3, 4}, {2, 2}, {4, 5}}},
                                      vector<char>{1, 1}, array<array<char,2>,3>{{{0, 0}, {1, 3}, {0, 3}}}, layouts[j]);
        ...
        indexed_dpd_varray<double> v31(1, 2, array<array<char,2>,6>{{{3, 1}, {2, 2}, {1, 2}, {3, 4}, {2, 2}, {4, 5}}},
                                       vector<char>{1, 1}, array<array<char,2>,3>{{{0, 0}, {1, 3}, {0, 3}}}, 1.0, layouts[j]);
...
TEST(indexed_dpd_varray, reset)
{
    ...
    for (int j = 0;j < 6;j++)
    {
        ...
        v1.reset(1, 2, array<array<char,2>,6>{{{3, 1}, {2, 2}, {1, 2}, {3, 4}, {2, 2}, {4, 5}}},
                                      vector<char>{1, 1}, array<array<char,2>,3>{{{0, 0}, {1, 3}, {0, 3}}}, layouts[j]);
        CHECK_INDEXED_DPD_VARRAY(v1, j, 0.0)
