...
TEST(marray, reset)
{
    ...
    v1.reset({4, 2, 5});
    EXPECT_EQ((array<idx_type,3>{4, 2, 5}), v1.lengths());
    ...
    v1.reset();
    EXPECT_EQ(nullptr, v1.data());
    EXPECT_EQ((array<idx_type,3>{0, 0, 0}), v1.lengths());
...
TEST(marray, resize)
{
    ...
    v1.resize({2, 2});
    EXPECT_EQ((array<idx_type,2>{2, 2}), v1.lengths());
    ...
    EXPECT_EQ((array<idx_type,2>{3, 4}), v1.lengths());
...
TEST(marray, push_pop)
{
    ...
    v1.push_back(0, v2);
    EXPECT_EQ((array<idx_type,2>{3, 3}), v1.lengths());
    ...
    v1.pop_back(0);
    EXPECT_EQ((array<idx_type,2>{2, 4}), v1.lengths());
    EXPECT_EQ((array<stride_type,2>{4, 1}), v1.strides());
    EXPECT_EQ((array<double,8>{0, 1, 2, -1,
                               3, 4, 5, -1}), *(array<double,8>*)v1.data());

    v1.pop_back(1);
    EXPECT_EQ((array<idx_type,2>{2, 3}), v1.lengths());
    EXPECT_EQ((array<stride_type,2>{3, 1}), v1.strides());
    ...
    EXPECT_EQ((array<idx_type,1>{7}), v4.lengths());
    ...
    EXPECT_EQ((array<idx_type,1>{5}), v4.lengths());
    EXPECT_EQ((array<stride_type,1>{1}), v4.strides());
...
TEST(marray, lowered)
{
    ...
    auto v3 = v1.lowered(array<char,1>{1});
    EXPECT_EQ((array<idx_type,2>{4, 10}), v3.lengths());
    EXPECT_EQ((array<stride_type,2>{10, 1}), v3.strides());
    EXPECT_EQ(v1.data(), v3.data());

    auto v4 = v1.lowered<1>({});
    EXPECT_EQ((array<idx_type,1>{40}), v4.lengths());
    EXPECT_EQ((array<stride_type,1>{1}), v4.strides());
    EXPECT_EQ(v1.data(), v4.data());
...
TEST(marray, front_back)
{
    ...
    auto v3 = v2.cfront(0);
    EXPECT_EQ((array<idx_type,2>{2, 5}), v3.lengths());
    EXPECT_EQ((array<stride_type,2>{5, 1}), v3.strides());
    EXPECT_EQ(v2.data(), v3.data());

    auto v4 = v2.front(1);
    EXPECT_EQ((array<idx_type,2>{4, 5}), v4.lengths());
    ...
    EXPECT_EQ((array<idx_type,2>{4, 5}), v8.lengths());
...
TEST(marray, access)
{
    ...
    EXPECT_EQ((array<idx_type,2>{4, 2}), v7.lengths());
    ...
    EXPECT_EQ((array<idx_type,1>{2}), v8.lengths());
    ...
    EXPECT_EQ((array<idx_type,2>{4, 2}), v9.lengths());
    ...
    EXPECT_EQ((array<idx_type,2>{2,3}), v10.lengths());
    ...
    EXPECT_EQ((array<idx_type,1>{3}), v11.lengths());
...
TEST(marray, swap)
{
    ...
    EXPECT_EQ((array<idx_type,3>{3, 8, 3}), v1.lengths());
    ...
    EXPECT_EQ((array<idx_type,3>{3, 8, 3}), v2.lengths());
