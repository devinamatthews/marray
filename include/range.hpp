...
{
    typedef typename detail::underlying_type_if<typename std::common_type<T,U>::type>::type V;
...
{
    typedef typename detail::underlying_type_if<typename std::common_type<T,U,V>::type>::type W;
